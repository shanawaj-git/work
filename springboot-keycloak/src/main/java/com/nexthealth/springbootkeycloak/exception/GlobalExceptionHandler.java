...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> resourseNotFoundException(ResourceNotFoundException ex, WebRequest req) {
    ...
    public ResponseEntity<?> globalException(JsonProcessingException ex, WebRequest request) {

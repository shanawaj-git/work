...
async function createRouter(options) {
  ...
  router.get("/sync/:namespace/:kind/:name", async (req, res) => {
    ...
    if (req.header("accept") !== "text/event-stream") {
      console.warn("The call to /sync/:namespace/:kind/:name wasn't done by an EventSource. This behavior is deprecated and will be removed soon. Make sure to update the @backstage/plugin-techdocs package in the frontend to the latest version.");
...
function createHttpResponse(res) {
  return {
    log: () => {
    },
    error: (e) => {

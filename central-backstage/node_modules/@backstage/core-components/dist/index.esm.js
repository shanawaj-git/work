...
function WarningPanel(props) {
  ...
  const classes = useStyles$J({ severity });
...
const useStyles$v = makeStyles(() => createStyles({
  icon: {
    position: "absolute",
    right: "4px",
    pointerEvents: "none"
...
const Sidebar = (props) => {
  ...
  const { isMobile } = useContext(SidebarPinStateContext);
  return isMobile ? /* @__PURE__ */ React.createElement(MobileSidebar, null, children) : /* @__PURE__ */ React.createElement(DesktopSidebar, {
    openDelayMs,
    closeDelayMs,
    disableExpandOnHover
  }, children);
...
const useStyles$j = (props) => makeStyles((theme) => {
  var _a, _b;
  return {
    root: {
      zIndex: 1e3,

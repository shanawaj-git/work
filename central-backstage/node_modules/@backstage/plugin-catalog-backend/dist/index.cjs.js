...
function location(newLocation, _optional) {
...
var deprecatedResult = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
function createRandomRefreshInterval(options) {
...
class CatalogBuilder {
  ...
  setRefreshIntervalSeconds(seconds) {
    this.env.logger.warn("[DEPRECATION] - CatalogBuilder.setRefreshIntervalSeconds is deprecated. Use CatalogBuilder.setProcessingIntervalSeconds instead.");
    this.processingInterval = createRandomProcessingInterval({
      minSeconds: seconds,
  ...
  setRefreshInterval(refreshInterval) {
    this.env.logger.warn("[DEPRECATION] - CatalogBuilder.setRefreshInterval is deprecated. Use CatalogBuilder.setProcessingInterval instead.");
...
exports.results = deprecatedResult;

package com.${{values.java_package_name}}.${{values.component_id}}.kafka.producer;
...
import com.${{values.java_package_name}}.${{values.component_id}}.domain.Event;
...
public class EventProducer {
    ...
    private void handleFailure(Throwable ex) {
        log.error("Error Sending create patient event {}", ex.getMessage());
    }

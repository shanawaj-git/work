...
- [How do I fix `Error: listen EADDRINUSE 127.0.0.1:3050`?](#how-do-i-fix-error-listen-eaddrinuse-1270013000)
...
## How do I fix `Error: listen EADDRINUSE 127.0.0.1:3050`?

This simply means that there's another process already listening on port 3050.
...
1. Find the process id (PID):
    ...
    > ```
    >
    > Note: If nothing is listed, you can try `lsof -i tcp:3050`
...
1. Find the process id (PID):
    ...
    > ...
    > TCP       0.0.0.0:3050      0.0.0.0:0         Listening   28344
    > ```
...
output: {
  publicPath: 'http://127.0.0.1:3050/',
  /* … */
},
```
